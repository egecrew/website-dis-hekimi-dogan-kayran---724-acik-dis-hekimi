    ...
    <div className="app">
      ...
      <header className="header">
        <div className="container">
          <div className="logo">🏢 Diş Hekimi Doğan Kayran - 7/24 Açık Diş Hekimi</div>
        ...
        <div className="container">
          ...
          <div className="about-content">
            ...
            <div style={{marginTop: '1.5rem', padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '8px'}}>
                ...
                <br />
                <a href="https://egecrew.github.io/website-dis-hekimi-dogan-kayran---724-acik-dis-hekimi/" target="_blank" rel="noopener noreferrer" style={{color: '#0066cc'}}>
                  egecrew.github.io/website-dis-hekimi-dogan-kayran---724-acik-dis-hekimi
                </a>
              </div>
              </div>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <p>Diş Hekimi Doğan Kayran - 7/24 Açık Diş Hekimiin büyümesine katkı sağlayacak stratejiler ve çözümler.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="info-item">
                ...
                <div>
                  <h3>Email</h3>
                  <p>info@amerikanhastanesi.org</p>
                </div>
              </div>
              ...
              <div className="info-item">
                ...
                <div>
                  <h3>Adres</h3>
                  <p>Meetpoint Avm, Müskebi, Cumhuriyet Cd. No:29/23, 48400 Bodrum/Muğla, Türkiye</p>
                </div>
              </div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-section">
              <h4>İletişim</h4>
              <p>+90 (252) XXX-XXXX<br/>info@amerikanhastanesi.org</p>
            </div>
          </div>
          <div className="footer-bottom">
            <p>&copy; 2026 Diş Hekimi Doğan Kayran - 7/24 Açık Diş Hekimi. Tüm hakları saklıdır.</p>
